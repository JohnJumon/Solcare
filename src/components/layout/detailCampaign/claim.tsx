    ...
    return (
        <div className="
            ...
            <p className="
                ...
                md:text-3xl md:mb-4">
                <b>100<span className="
                    text-[8px]
                    md:text-[15px]">USDC</span></b>
            </p>
            <p className="
                text-[6px] mb-2
                md:text-[12px] md:mb-4">
                Silahkan menekan tombol dibawah untuk klaim kembali donasi yang telah kamu berikan.
            </p>
            <button className="
