                ...
                <tr className="bg-white border-b">
                    <th scope="row" className="
                        ...
                        <img className="
                            ...
                            md:w-16 md:h-16" src={ProfilePlaceholder} alt="placeholder" />
                        <div className="
                            pl-3
                            md:pl-6">
                            <div className="
                                text-xs font-bold line-clamp-1
                                md:text-xl">Nama {i + 1}</div>
                            <div className="
                                text-[8px] font-normal text-gray-500
                                md:text-[15px]">Wallet {i + 1}</div>
                        </div>
                    </th>
                    <td className="
    ...
    return (
        <div className="
            ...
            <h2 className="
                ...
                md:text-xl md:mb-2">Daftar Funders</h2>
            ...
            <nav className="
                ...
                <span className="
                    ...
                    md:text-xl md:pt-4">Showing <span className="font-bold text-gray-900">{parseInt(currentValue)*5-5+1}-{parseInt(currentValue)*5}</span> of <span className="font-bold text-gray-900">{5*20}</span></span>
