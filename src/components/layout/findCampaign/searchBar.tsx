    ...
    return(
        <div className="relative mt-[25px] mb-6 md:mt-[50px] rounded-[10px]">
            <input type="text" className="
                ...
                md:text-xl md:p-4" placeholder="Cari nama campaign..." aria-label="Search"/>
            <button type="submit" className="
                ...
                <svg aria-hidden="true" className="
                    w-3 h-3
                    md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
