        ...
        for (const link of links) {
            if (link == currentPage) {
                components.push(
                    <li>
                        <a
                            className="active:bg-[#007BC7] text-lg font-bold stroke-black active:stroke-white"
                            onClick={() => {
                                changePage(link);
                                handleClick();
                            }}
                        ...
                        <div className="collapse collapse-arrow">
                            ...
                            <div className="collapse-content">
                                <li>
                                    <a
                                        onClick={() => {
                                            changePage('Verifikasi User');
                                            handleClick();
                                        }}
                                        className="active:bg-[#007BC7] !flex !flex-row items-center font-bold text-lg stroke-black active:stroke-white"
                                    >
                                        Verifikasi User
                                    </a>
                                </li>
                ...
                components.push(
                    <li>
                        <a
                            className="active:bg-[#007BC7] text-lg stroke-black active:stroke-white"
                            onClick={() => {
                                changePage(link);
                                handleClick();
                            }}
