...
const Intro = () => {
    ...
    useEffect(() => {
        const fadeTimeout = setInterval(() => {
            currentFade === "fade-in" ? setCurrentFade("fade-out") : setCurrentFade("fade-in")
        }, 3500)
        ...
        <article className="
            ...
            <div className="
                ...
                <p className="
                    ...
                    xl:text-xl xl:mb-6
                    ">Buatlah <i>campaign</i> dan kumpuli dana untuk projek anda, dan jadilah <i>funder</i> untuk membantu mendanai <i>campaign</i>. Dengan teknologi <i>blockchain</i>, transaksi menjadi transparan dan aman.</p>
                <button className="
