        ...
        <div className="flex flex-col">
            ...
            <div className="mt-4 flex flex-col md:flex-row gap-4">
                <div>
                    ...
                    <label htmlFor="dropzone-file" className={`hover:brightness-90 shrink-0 md:h-40 md:w-40 h-28 w-full bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center border-2 border-gray-300 border-dashed rounded-[10px] cursor-pointer`}>
            ...
            <div className="flex flex-row gap-4 items-center mt-4">
                ...
                <p className='basis-1/2 text-xs md:text-lg'>Status verifikasi</p>
            </div>
