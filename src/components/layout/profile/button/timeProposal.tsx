            ...
            <div>
                ...
                <label htmlFor="my-modal-4" className="modal max-[768px]:modal-bottom cursor-pointer px-0 md:px-12">
                    <label className="modal-box relative rounded-t-[10px] md:rounded-[20px] w-[54rem] max-w-screen-2xl md:max-h-screen-2xl">
                        <h1 className="text-md font-bold md:text-3xl">Perpanjangan Waktu</h1>
                        <div className="divider" />
                        <div className="grid sm:grid-rows-2 sm:grid-cols-2 grid-rows-4 grid-cols-1 items-center gap-x-2 mb-2">
                            <p className="text-xs md:text-xl font-bold">Sisa Hari Belum Terpakai</p>
                            <p className="self-center justify-self-center text-base font-bold md:text-3xl py-auto">60<span className="text-[8px] md:text-[15px]"> Hari</span></p>
                            <p className="text-xs md:text-xl font-bold">Tambahan Hari</p>
                            <div className="
                                ...
                                <input className="
                                            ...
                                            md:text-xl md:p-4 md:mr-4 md:rounded-[10px]" type="number" min="1" max="90" defaultValue="1" />
                                <p className="
