    ...
    return (
        <div className="flex flex-col">
            ...
            <div>
                ...
                <label htmlFor="my-modal-4" className="modal max-[768px]:modal-bottom cursor-pointer px-0 md:px-12 w-screen">
                    <label className="modal-box relative rounded-t-[10px] md:rounded-[20px] w-[54rem] max-w-screen-2xl md:max-h-screen-2xl">
                        <h1 className="text-md font-bold md:text-3xl">Pengiriman Bukti</h1>
                        <div className="divider" />
                        <p className="text-xs md:text-xl font-bold">Upload Berkas Keberhasilan Proyek</p>
