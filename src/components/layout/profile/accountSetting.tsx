    ...
    return (
        <div className="flex flex-col">
            <div className="
                ...
                <label htmlFor="dropzone-file" className={`shrink-0 md:h-28 md:w-28 h-24 w-24 bg-[url('${ProfilePlaceholder}')] bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center border-2 border-gray-300 border-dashed rounded-full cursor-pointer hover:brightness-90`}>
                ...
                <div className="basis-10/12 shrink flex flex-col items-center md:items-start my-4 md:my-0 md:mx-4">
                    <h2 className="text-lg font-bold
                        md:text-xl">Nama</h2>
                    <p className="text-sm
                        md:text-base">Wallet Address</p>
                </div>
                <p className="basis-1/12 shrink-0 text-center text-xs 
